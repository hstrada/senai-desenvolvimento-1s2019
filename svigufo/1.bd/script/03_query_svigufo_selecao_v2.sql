...
SELECT COUNT(*) AS QTD_TIPOSEVENTOS FROM TIPOS_EVENTOS;
SELECT COUNT(*) AS QTD_USUARIOS FROM USUARIOS;
SELECT COUNT(*) AS QTD_EVENTOS_PUBLICOS FROM EVENTOS WHERE ACESSO_LIVRE = 1;
SELECT COUNT(*) AS QTD_EVENTOS_PRIVADO FROM EVENTOS WHERE ACESSO_LIVRE = 0;

SELECT  (SELECT COUNT(*) FROM TIPOS_EVENTOS) AS QTD_TIPOSEVENTOS,
