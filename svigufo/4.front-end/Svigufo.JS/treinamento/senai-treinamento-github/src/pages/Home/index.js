...
class Index extends Component {
  ...
  handleSubmit(event) {
    ...
    const urlUsuario =
      ...
      this.state.username +
      "?client_id=d5bc19cf1d20805db514&client_secret=6d1dac6956abad6f4547d6a8377cff12fcb84570";

    const urlRepositorio =
      "https://api.github.com/users/" +
      this.state.username +
      "/repos?client_id=d5bc19cf1d20805db514&client_secret=6d1dac6956abad6f4547d6a8377cff12fcb84570";
          ...
          <Row>
            <Col xs={3}>
              {this.state.dadosusuario != null && (
                <Username dadosusuario={this.state.dadosusuario} />
              )}
            </Col>
            <Col xs={9}>
